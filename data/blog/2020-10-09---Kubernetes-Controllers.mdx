...
summary: 쿠버네티스에서 포드의 배포를 관리하는 컨트롤러에 대해 알아봅시다
...
<figure>
  <img src="/static/media/kubernetes_controller/replication_controller.jpg" alt="" width="600" />
...
<figure>
  <img src="/static/media/kubernetes_controller/demonset.jpg" alt="" width="700" />
