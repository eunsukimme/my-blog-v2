...
위 과정을 일반적으로 다음과 같이 [5단계](https://developers.google.com/web/fundamentals/performance/rendering/#the_pixel_pipeline)로 구분하여 표현한다,
...
<figure>
  <img
    src="https://developers.google.com/web/updates/images/inside-browser/part3/pagejank2.png"
    alt="page jank"
  />
  <figcaption style={{ color: 'grey' }}>
    Page jank(출처: https://developers.google.com/web/updates/2018/09/inside-browser-part3)
  </figcaption>
</figure>
...
<figure style={{ backgroundColor: '#202226' }}>
  <img
    src="https://pomb.us/static/a88a3ec01855349c14302f6da28e2b0c/ac667/fiber1.png"
    alt="Fiber tree"
  />
