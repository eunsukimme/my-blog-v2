...
summary: 쿠버네티스에서 애플리케이션을 실행할 때 설정 옵션과 시크릿 정보를 전달하는 방법에 대해서 알아봅시다
...
<figure>
  <img src="/static/media/kubernetes_configmap/configmap1.jpeg" />
  <figcaption style={{ color: 'grey' }}>
    서로 다른 환경에서 동일한 이름을 갖는 두 컨피그맵
  </figcaption>
</figure>
...
<figure>
  <img src="/static/media/kubernetes_configmap/configmap2.jpeg" />
